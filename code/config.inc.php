 ...
 */
    ...
    $this->dbHost = '172.17.0.3'; // database host name
    $this->dbName = 'database'; // database name
    $this->dbUser = 'user'; // database user name
    $this->dbPwd = 'password'; // database user password
    $this->dbType = 'mysql';
    $this->sShopURL = 'http://oxid.dev:8083'; // eShop base url, required
    $this->sSSLShopURL  = null;            // eShop SSL url, optional
    $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
    $this->sShopDir = '/var/www';
    $this->sCompileDir = '/var/www/tmp';
     ...
     */
    $this->captchaKey = '329c9fb1adb4203fa6f8fce53c2cb723';
